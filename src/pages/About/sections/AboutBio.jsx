        ...
        <div className="w-full py-20 px-6 relative overflow-visible">
            ...
            <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative">
                     {/* Photo 1 */}
                     <div className="relative z-10 bg-white p-4 pb-12 shadow-xl transform -rotate-3 hover:rotate-0 transition-transform duration-500 max-w-sm ml-auto md:mr-10">
                ...
                <div>
                     ...
                     <div className="p-6 bg-brand-dark rounded-2xl text-white relative">
