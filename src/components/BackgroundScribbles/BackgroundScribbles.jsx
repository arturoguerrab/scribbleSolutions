...
const BackgroundScribbles = ({ variant = "mixed", className = "" }) => {
	...
	const opacity = 0.3; // Significantly increased for clear visibility
	...
	return (
		...
		>
			...
			<svg
				className="absolute top-[10%] left-[5%] w-32 h-32 opacity-10"
				viewBox="0 0 100 100"
			...
			<svg
				className="absolute bottom-[15%] left-[15%] w-48 h-48 opacity-10"
				viewBox="0 0 200 200"
			>
				<path
					d="M20,100 C50,50 150,50 180,100 S150,150 20,100"
					fill="none"
					stroke={strokeColor}
					strokeWidth="2"
			...
			<svg
				className="absolute bottom-[25%] right-[5%] w-24 h-24 opacity-10"
				viewBox="0 0 100 100"
			>
				<rect
					x="20"
